      ...
      <div className='flex w-4/5'>
        ...
        <div className='mt-8 container mx-auto px-7'>
          <span className='text-yellow-600'>
            Para disponibilizar nossos serviços, precisamos coletar alguns dados de nossos usuários.
            Nós não coletamos dados que não serão necessários para o funcionamento de nossos
            serviços. Precisamos deixar claro que, este documento pode ser alteado a qualquer
            momento, por isso, auxiliamos que sempre que for utilizar de nossos serviços, cheque
            este documento para entender como nós tratamos o que usamos.
          </span>
          ...
          garante que nenhum dado será distribuído, vendido ou doado para terceiros. Ela também
          garante que os dados estão salvos de forma segura em um Banco de Dados robusto em questões
          de segurança.
          <h2 className='text-2xl mt-1'>Serviços de Terceiros</h2>A Menhera é um aplicativo que roda
          dentro do Discord, por isso, segue as regras e normas de lá, assim como seus usuários o
          devem fazer.
          <h2 className='text-2xl mt-1'>Exclusão de Dados</h2>O usuário pode ter seus dados apagados
          da Menhera a qualquer momento diretamente pela aplicação, ou enviando um email para{' '}
        ...
        <div className='mt-8 container mx-auto px-7'>
          ...
          Ao descobrir um bug, e ao invés de reportá-lo, você abusa dele e, até compartilha ele,
          você está sujeito a perder o acesso à todas funcionalidades da Menhera
          <h2 className='text-2xl mt-1'>Idade</h2> Para utilizar à Menhera, você deve ter no mínimo
          13 anos de idade. Pessoas menores da idade legal devem ter o consentimento do guardião
          legal sobre estes termos antes de utilizá-lo.
          ...
          <ol className='list-disc'>
            ...
            <li>
              ...
              divertir os servidores, caso seu servidor promove ou possui vínculo com atitudes que
              denigrem a imagem de alguém, então nós não queremos vínculos com você.
            </li>
            <li>
          ...
          <a href='https://github.com/MenheraBot/MenheraBot/discussions/132' className='underline'>
