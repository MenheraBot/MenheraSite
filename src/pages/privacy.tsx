    ...
    <>
      ...
      <div className='mt-8 container mx-auto px-7'>
        <span className='text-yellow-600'>
          ...
          Nós não coletamos dados que não serão necessários para o funcionamento de nossos serviços.
      ...
      <div className='mt-8 container mx-auto px-7'>
        <span className='text-yellow-600'>
          Ao utilizar qualquer serviço da Menhera, você deve ter a conciência de tudo que você pode
          e não pode fazer. Ao utilizá-la, levamos em conta que você <b>LEU</b> e <b>CONCORDA</b>{' '}
          com todos estes termos
        </span>
        ...
        <ol className='list-disc'>
          ...
          <li>
            ...
            caso seu servidor promove ou possui vínculo com atitudes que denigrem a imagem de
            alguém, então nós não queremos vínculos com você.
          </li>
          <li>
...
export const getStaticProps: GetStaticProps = async ({ locale }) => {
  return {
    props: {
      ...(await serverSideTranslations(locale as string, ['privacy', 'header', 'footer'])),
    },
  };
};
