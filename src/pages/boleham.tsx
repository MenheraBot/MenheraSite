            ...
            <div className='flex-1 bg-gray-medio flex items-center border-b border-gray-900 justify-between px-4'>
              <div className='flex items-center'>
                ...
                <div className='border-l pl-3 ml-3 border-gray-600 text-sm text-gray-400'>
                  Como configurar um servidor SSL com Bash e Wsl
                </div>
              </div>
              <div className='flex items-center'>
                <form onSubmit={searchInput} className='relative ml-4 focus:w-5'>
                  <input
                    ...
                    className='flex focus:w-64 rounded focus:outline-none bg-gray-900 text-gray-200 text-sm px-2 py-1'
                  />
                ...
                <div className='text-sm overflow-y-auto chat'>
                  <div className='flex py-1 mb-3 hover:bg-gray-usr'>
                    ...
                    <div className='ml-2'>
                      ...
                      {/* TEXT GO HERE */} Oiii, bem vinda ao mundo de Boleham. Se tu chegou até
                      aqui tu é foda, já que essa página ta em desenvolvimento Aqui não tem nada de
                      interessante (por enquanto), então clique na Menhera (canto superior esquerdo)
                  ...
                  <div className='flex py-1 mb-3 hover:bg-gray-usr'>
                    <div className='flex-none ml-3'>
                      <Image
                        className='rounded-full'
                        src='https://cdn.discordapp.com/avatars/708014856711962654/33d7e40a952b7fe9b8d633d7521e5229.png'
                        width='40'
                        height='40'
                        alt='user'
                      />
